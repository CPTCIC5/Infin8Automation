        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-6">Last updated: August 27, 2024</p>

              <p className="text-gray-700 mb-4">Value Amplify producer of Sales Genio AI</p>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-secondary mb-4">Interpretation and Definitions</h2>
                ...
                <ul className="list-disc pl-6 mb-4 text-gray-700">
                  ...
                  <li><strong>Company:</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Value Amplify producer of Sales Genio AI, unit G301, 400 Coco beach, Rio grande, 00745.</li>
                  <li><strong>Cookies:</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</li>
                  <li><strong>Country:</strong> refers to PR, United States.</li>
                  ...
                  <li><strong>Website:</strong> refers to Value Amplify producer of Sales Genio AI, accessible from https://salesgenio.ai/</li>
                  <li><strong>You:</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
                </ul>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-secondary mb-4">Collecting and Using Your Personal Data</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-secondary mb-4">Tracking Technologies and Cookies</h2>
                <p className="text-gray-700 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-secondary mb-4">Use of Your Personal Data</h2>
                <p className="text-gray-700 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-secondary mb-4">Retention of Your Personal Data</h2>
                <p className="text-gray-700 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-secondary mb-4">Transfer of Your Personal Data</h2>
                <p className="text-gray-700 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-secondary mb-4">Delete Your Personal Data</h2>
                <p className="text-gray-700 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-secondary mb-4">Disclosure of Your Personal Data</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-secondary mb-4">Security of Your Personal Data</h2>
                <p className="text-gray-700 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-secondary mb-4">Links to Other Websites</h2>
                <p className="text-gray-700 mb-4">
